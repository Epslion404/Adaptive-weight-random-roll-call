...
.\.venv\Scripts\python.exe -m nuitka --mingw64 --standalone --onefile --output-dir=release-exe --windows-icon-from-ico=favicon.ico --windows-console-mode=disable --enable-plugin=tk-inter main.py
.\.venv\Scripts\python.exe -m nuitka --mingw64 --standalone --onefile --output-dir=release-config --windows-icon-from-ico=favicon.ico --windows-console-mode=disable --enable-plugin=tk-inter config.py
pause